...
class NeuralNetwork:
    ...
    def update_parameters(self, gradients, learning_rate):
        ...
        bn1_params = self.bn1.get_parameters()
        bn1_params['gamma'] -= learning_rate * gradients["dgamma1"]
        bn1_params['beta'] -= learning_rate * gradients["dbeta1"]
        self.bn1.set_parameters(bn1_params)
