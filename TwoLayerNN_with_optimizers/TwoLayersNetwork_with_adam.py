...
class ModelTrainer:
    def __init__(self, model, X_train, Y_train, X_val, Y_val, X_test, Y_test,
        ...
        self.lr_schedule = lr_schedule or [
            (50, 1.0),  # Initial learning rate for 50 epochs
            (30, 0.1),  # 10% of initial lr for 30 epochs
            (20, 0.01),  # 1% of initial lr for 20 epochs
            (10, 0.001)  # 0.1% of initial lr for 10 epochs
        ]
...
if __name__ == "__main__":
    ...
    print("Loading data...")
    x_train, y_train, x_test, y_test, x_val, y_val = DataLoader.load_cifar10_data()
